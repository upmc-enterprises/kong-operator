...
import (
	v1 "github.com/upmc-enterprises/kong-operator/pkg/apis/cr/v1"
	scheme "github.com/upmc-enterprises/kong-operator/pkg/client/clientset/versioned/scheme"
...
func newClusters(c *CrV1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
